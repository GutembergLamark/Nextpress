...
// Nextpress definitions
define('WP_NEXTKEY', 'c5e53b87-d315-427d-a9f0-1d80d5f65f56');
define('WP_NEXTSITEURL', 'http://localhost/');


if($_SERVER['REQUEST_SCHEME'] === "https"){
	define('WP_HOME',       'https://localhost/dashboard');
	define('WP_SITEURL',    'https://localhost/dashboard');
}else {
	define('WP_HOME',       'http://localhost/dashboard');
	define('WP_SITEURL',    'http://localhost/dashboard');
}
